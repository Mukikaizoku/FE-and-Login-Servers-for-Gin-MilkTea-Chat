        ...
        public void ConnectToBackEnd()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    //IPAddress ipAddr = ipHost.AddressList[0].MapToIPv4();
                    //long parsedIP = 0;
                    //long.TryParse(backEndIp, out parsedIP);
                    //Console.WriteLine("Using IP = " + parsedIP);
                    backEndSock.Connect(new IPEndPoint(IPAddress.Parse(backEndIp), backEndPort));
                }
